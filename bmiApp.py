...
height_cm = st.number_input("กรอกน้ำส่วนสูงของคุณ (เซนติเมตร):", min_value=1.0)

#ส่วนที่ 3 สร้างปุ่มกดคำนวณ
if st.button("คำนวณค่า BMI💡"):
 # แปลงส่วนสูงจาก cm เป็น เมตร และคำนวณ BMI
...
#ส่วนที่ 4 แปลผลค่า bmi ตามเกณฑ์
 if bmi < 18.5:
  ...
  st.success("🏋️ คุณมีน้ำหนักในเกณฑ์ปกติ (รูปร่างดี)")
 elif 23.0 <= bmi < 25.0:
